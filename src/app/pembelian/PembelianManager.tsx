...
export default function PembelianManager({ operatorName }: { operatorName: string }) {
  ...
  return <main className="purchase-page">
    <header className="management-header"><div><p className="eyebrow">TANIBANGUN POS · PEMBELIAN</p><h1>Pembelian & Retur</h1><p>Kelola penerimaan barang dari supplier dan pengembalian pembelian.</p></div><div className="management-user">Masuk sebagai <b>{operatorName}</b><a href="/dashboard">← Dashboard</a></div></header>
