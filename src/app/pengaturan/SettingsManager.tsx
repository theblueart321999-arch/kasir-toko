...
export default function SettingsManager() {
  ...
  return <main className="management-page"><header className="management-header"><div><p className="eyebrow">TANIBANGUN POS · PENGATURAN</p><h1>Pengaturan Toko</h1><p>Kelola identitas toko, pajak, dan diskon produk.</p></div><a href="/dashboard">← Dashboard</a></header>
