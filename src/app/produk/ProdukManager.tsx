...
export default function ProdukManager({ operatorName }: { operatorName: string }) {
  ...
  return <main className="management-page">
    <header className="management-header"><div><p className="eyebrow">TANIBANGUN POS · PRODUK</p><h1>Kelola Produk</h1><p>Atur katalog, harga, stok, dan kategori toko.</p></div><div className="management-user">Masuk sebagai <b>{operatorName}</b><a href="/dashboard">← Dashboard</a></div></header>
